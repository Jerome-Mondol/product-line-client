        ...
        <footer className="bg-gray-800 text-white py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 className="text-2xl font-bold text-white mb-4">ProductLine</h3>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <button className="text-gray-400 hover:text-white transition-colors">TW</button>
                            <button className="text-gray-400 hover:text-white transition-colors">IG</button>
                            <button className="text-gray-400 hover:text-white transition-colors">LI</button>
                        </div>
                    </div>
                </div>
                <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
                    <p>&copy; 2024 ProductLine. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
